...
?>
    ...
    <p> Your application will be reviewed and you will receive an email for further information </p>
...
if (!$conn) {
    ...
    if(!isset($_POST['submit'])) {
        ...
        // check if other skill checkbox is checked, and other skill text area is empty
        // set error if true
